...
const importingData = async () => {
    try{
        const response:products[] = await client.fetch(`*[_type=="product"][0..43]{
            title,
            price,
            description,
            discountPercentage,
    ...
    <section className={fontPoppins.className}>
      ...
      <div className="flex flex-row justify-center gap-12 text-center m-12 max-lg:gap-9 max-lt:gap-7 max-mt:grid max-mt:grid-cols-2 max-mt:justify-items-center max-lm:flex max-lm:flex-col max-lm:items-center">
               {navLinks.map((link) => {
                   ...
                   return(
                      <div>
                        <div className={isActive ? "flex flex-row justify-center items-center text-center border-2 border-white rounded-xl w-[180px] h-[80px] bg-red-600 max-lg:w-[160px] max-lg:h-[60px] max-lt:w-[130px]": "flex flex-row justify-center items-center rounded-xl border-2 border-sky-100 text-center w-[150px] h-[80px] max-lg:w-[130px] max-lg:h-[60px] max-lt:w-[110px] bg-black hover:bg-red-600 hover:transition-all"}>
