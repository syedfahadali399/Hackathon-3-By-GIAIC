...
const importingData = async () => {
    try{
        const response:product[] = await client.fetch(`*[_type=="product"][30..46]{
            title,
            price,
            description,
            discountPercentage,
