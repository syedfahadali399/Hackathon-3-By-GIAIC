...
const importingData = async () => {
    try{
        const response:product[] = await client.fetch(`*[_type=="product"][18..29]{
            title,
            price,
            description,
            discountPercentage,
